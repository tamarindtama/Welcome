  ...
  var defaults = {
    ...
    methods = {
          ...
          if ($.isEmptyObject(settings)) {
            ...
            settings.$document.on('click.joyride', '.joyride-next-tip, .joyride-modal-bg', function (e) {
              ...
              if (settings.$li.next().length < 1) {
                methods.end();
                $("html, body").animate({
                  scrollTop: ($(".section4").offset().top)/1.05
      ...
      scroll_to : function () {
        ...
        window_half = settings.$window.height() / 1.4;
...
//      else if($("li").hasClass("j2")){
        $("html, body").stop().animate({
          scrollTop: ($(".section2").offset().top)/1.035
        }, settings.scrollSpeed);
      }
        ...
        $("html, body").stop().animate({
          scrollTop: ($(".section4").offset().top)/1.03
        }, settings.scrollSpeed);
      }   
      },
